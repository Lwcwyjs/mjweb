 ...
 */
@Controller
@RequestMapping("/business/txjl")
public class TxjlController extends BaseController {
    ...
    @RequestMapping("/main")
    public String main() {
        return "businessmanage/TxjlManager";
    }
    ...
    public Object getDataGrid(@RequestParam Map<String, Object> params, Integer page, Integer rows, String sort, String order) {
        try {
            ...
            if (params.containsKey("bgzt") && StringUtils.isNoneBlank(params.get("bgzt").toString())) {
                strWhere += String.format(" and bgzt='%s'", params.get("bgzt").toString());
            }
