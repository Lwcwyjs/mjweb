    ...
    <div class="layui-card">
        <div class="layui-card-body">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="loginname" id="loginname" class="layui-input"/>
                        </div>
            ...
            <div class="layui-row">
                ...
                <table class="layui-hide" id="userTable" lay-filter="vehicleFilter"></table>
            </div>
    ...
    layui.config({
        ...
        var renderTable = function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {
                        field: 'organ', title: '所属机构', sort: true, templet: function (d, row, index) {
                            var value = d.organ;
                            return getValue("organ", value, "${path }/admin/user/basedata/organ");
                        }
                    }
                    , {
                        field: 'id', title: '角色', sort: true, templet: function (d, row, index) {
                            var value = d.id;
                            return getValue("userrole", value, "${path }/admin/user/basedata/userrole");
                        }
        ...
        $(document).on('click', '#addDetail', function () {
            ...
            parent.layer.open({
                ...
                skin: 'my-skin',
                area: ['500px', '500px'],
                content: ['${path}/admin/user/addPage'],
                end: function () {
                    renderTable();
                }
            });
        ...
        table.on('tool(vehicleFilter)', function (obj) {
            ...
            if (obj.event === 'editDetail') {
                ...
                parent.layer.open({
                    ...
                    area: ['500px', '500px'],
                    skin: 'my-skin',
                    content: ['${path}/admin/user/editPage?id=' + data.id],
                    end: function () {
                        renderTable();
                    }
                });
