 ...
 */
@Controller
@RequestMapping("/count/cltxpf")
public class CltxpfController extends BaseController {
    ...
    @RequestMapping(value = "/cltxpfsj", method = RequestMethod.POST) // 整车通过率统计
    @ResponseBody
    ...
    @RequestMapping(value = "/cltxpfpie", method = RequestMethod.POST) // 整车通过率统计
    @ResponseBody
