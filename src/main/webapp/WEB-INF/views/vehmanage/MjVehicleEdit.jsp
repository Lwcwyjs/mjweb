                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input id="cphm" name="cphm" placeholder="" class="layui-input"
                                       lay-verify="required" disabled="true"
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input id="clsbdh" name="clsbdh" placeholder="" class="layui-input" disabled="true"
                                       lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select id="pfbz" name="pfbz" lay-filter="jclxFilter" lay-verify="required" readonly="true"
                                        lay-search>
                                    <option value="">请选择</option>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select id="cllx" name="cllx" lay-filter="shztFilter"  readonly="true">
                                    <option value="">请选择</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input id="pfpdyj" name="pfpdyj" placeholder="" class="layui-input" style="width:545px" readonly="true"
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <img id="xszazp"  style="width: 200px">
                            </div>
                        </div>
                    </div>
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <img id="xszbzp"  style="width: 200px">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item" >
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <img id="scqdzp"  style="width: 200px">
                            </div>
                        </div>
                    </div>
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <img id="vehiclezp"  style="width: 200px">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    layui.config({
        ...
        var tree = layui.tree;
        var $ = layui.jquery;
        var imgElementxszazp = document.getElementById('xszazp');
        imgElementxszazp.style.display="none";
        var imgElementxszbzp = document.getElementById('xszbzp');
        imgElementxszbzp.style.display="none";
        var imgElementscqdzp = document.getElementById('scqdzp');
        imgElementscqdzp.style.display="none";
        var imgElementvehiclezp = document.getElementById('vehiclezp');
