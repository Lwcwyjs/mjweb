    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="layui-form toolbar" id="vehicleForm">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="licensePlate" id="licensePlate" class="layui-input"/>
                        </div>
                        <label class="layui-form-label">车牌颜色</label>
                        <div class="layui-input-inline">
                            <select id="licensePlateColor" name="licensePlateColor" lay-filter="shztFilter">
                    ...
                    <div class="layui-inline">
                        <div class="layui-inline">
                            <button id="yuyueBtnSearch" class="layui-btn icon-btn"><i
                                    class="layui-icon"></i>查询
                            </button>
                            <button type="reset" class="layui-btn icon-btn" id="yuyueBtnClear"><i
            ...
            <div class="layui-row">
                ...
                <table class="layui-hide" id="yuyueTable" lay-filter="vehicleFilter"></table>
            </div>


            <script type="text/html" id="actionHandle" lay-event="detail">
                <shiro:hasPermission name="/local/yuyue/edit">
                ...
                <shiro:hasPermission name="/local/yuyue/del">
					<span style="height: 24px; background-color: transparent; cursor: pointer;"
    ...
    layui.config({
        ...
        var renderTable = function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    {field: 'licenseplate', title: '车牌号码', align: 'center', sort: true},
                    {
                    ...
                    {field: 'begintime', title: '生效时间', align: 'center', sort: true},
                    {field: 'endtime', title: '终止时间', align: 'center', sort: true},
                    {field: 'cjsj', title: '更新时间', align: 'center', sort: true},
                    {field: 'getecode', title: '出入口编号', align: 'center', sort: true},
                    {
        ...
        $(document).on('click', '#addDetail', function () {
            ...
            parent.layer.open({
                ...
                skin: 'my-skin',
                area: ['800px', '450px'],
                content: ['${path}/local/yuyue/addPage'],
                end: function () {
                    renderTable();
                }
            });
        ...
        // 搜索按钮点击事件
        $('#yuyueBtnSearch').click(function () {
            var cphm = $('#licensePlate').val();
            var organ = $('#organ').val();
            var cpys = $('#cpys').val();
            table.reload('yuyueTable', {
                page: {
                    curr: 1//重新从第一页开始
                }
                ,where: {
        ...
        table.on('tool(vehicleFilter)', function (obj) {
            ...
            if (obj.event === 'editDetail') {
                ...
                parent.layer.open({
                    ...
                    area: ['800px', '450px'],
                    skin: 'my-skin',
                    content: ['${path}/local/yuyue/editPage?id=' + data.dataid],
                    end: function () {
                        renderTable();
                    }
                });
