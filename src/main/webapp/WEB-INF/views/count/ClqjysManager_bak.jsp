...
<script>
    ...
    layui.use(['element','form', 'table', 'tree', 'laydate', 'formSelects'], function () {
        ...
        var params = {qybh: $('#organ').val(), jclx: $('#jclx').val(), kssj: $('#kssj').val(), jssj: $('#jssj').val()};
        // 初始化
        getChartData(params);
        ...
        $('#exportExcel').click(function () {
            ...
            var kssj = $('#kssj').val();
            var jssj = $('#jssj').val();
            window.location.href='${path}/count/clqjys/getExcel?jclx='+jclx+'&organ='+organ+'&kssj='+kssj+'&jssj='+jssj;
        });
        laydate.render({
            elem: '#kssj'
        });
    ...
    function getChartData(params) {
        $.ajax({
            type: "post",
            url: '${path}/count/clqjys/clqjyssj',
            data: params,
            dataType: 'json',
            success: function (cltxpfList) {
                if(cltxpfList!=""){
                    ...
                    $("#cltxptable").html("");
                    shtml="<table>"
                    shtml = shtml + '<tr><td>排放阶段</td><td>进出辆次</td></tr>';
                    for (var i = 0; i < cltxpfList.length; i++) {
                        shtml = shtml + '<tr><td>'+cltxpfList[i].pfbz+'</td><td>'+cltxpfList[i].jclc+'</td></tr>';
                    }
                    shtml=shtml+"</table>";
        ...
        $.ajax({
            type: "post",
            url: '${path}/count/clqjys/clqjyspie',
            data: params,
            dataType: 'json',
            success: function (d) {
                // $("[selectOrgan]").html("");
        ...
        $.ajax({
            type: "post",
            url: '${path}/count/clqjys/clqjyswsj',
            data: params,
            dataType: 'json',
            success: function (cltxpfList) {
                if(cltxpfList!=""){
        ...
        $.ajax({
            type: "post",
            url: '${path}/count/clqjys/clqjyswpie',
            data: params,
            dataType: 'json',
            success: function (d) {
                // $("[selectOrgan]").html("");
