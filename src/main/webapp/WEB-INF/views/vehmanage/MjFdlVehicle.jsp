    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="layui-form toolbar" id="vehicleForm">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="hbdjhm" id="hbdjhm" placeholder="可模糊查询" class="layui-input"/>
                        </div>
            ...
            <script type="text/html" id="actionHandle" lay-event="detail">
                <shiro:hasPermission name="/business/mjfdlvehicle/edit">
                ...
                <shiro:hasPermission name="/business/mjfdlvehicle/del">
					<span style="height: 24px; background-color: transparent; cursor: pointer;"
...
<script>
    layui.config({
        ...
        var renderTable = function () {
            ...
            table.render({
                elem: '#vehTable'
                , url: '${path}/business/mjfdlvehicle/dataGrid'
                , method: 'GET'
                , request: {
                ...
                , cols: [[
                    ...
                    {field: 'hbdjhm', title: '环保登记号码', align: 'center', sort: true},
                    {field: 'jxxh', title: '机械型号', align: 'center', sort: true},
                    {field: 'scrq', title: '生产日期', align: 'center', sort: true},
                    {
                        field: 'pfbz',
                        title: '排放标准',
                        align: 'center',
        ...
        $(document).on('click', '#addDetail', function () {
            ...
            parent.layer.open({
                ...
                skin: 'my-skin',
                area: ['800px', '600px'],
                content: ['${path}/business/mjfdlvehicle/addPage'],
                end: function () {
                    renderTable();
                }
            });
        ...
        $('#exportExcel').click(function () {
            ...
            // 3. 发起导出请求（保持不变）
            var url = '${path}/business/mjfdlvehicle/startExport';
            var params = {
                hbdjhm: hbdjhm,
                qybh: qybh,
                pfbz: pfbz,
                ...
                success: function (data) {
                    if (data.code == 1) {
                        ...
                        var pollInterval = setInterval(function () {
                            $.ajax({
                                type: "post",
                                url: '${path}/business/mjfdlvehicle/exportProgress',
                                data: {taskId: taskId},
                                dataType: 'json',
                                success: function (progressRes) {
                                    ...
                                    if (progress === -1) {
                                        ...
                                        setTimeout(function () {
                                            window.location.href = '${path}/business/mjfdlvehicle/downloadExcel?taskId=' + taskId;
                                            resetUI(); // 下载后重置
                                        }, 500);
                                    } else {
                                        // 更新进度
        ...
        table.on('tool(vehicleFilter)', function (obj) {
            ...
            if (obj.event === 'editDetail') {
                ...
                parent.layer.open({
                    ...
                    area: ['800px', '600px'],
                    skin: 'my-skin',
                    content: ['${path}/business/mjfdlvehicle/editPage?id=' + data.id],
                    end: function () {
                        renderTable();
                    }
                });
                ...
                layer.confirm('确定要删除吗',
                    function (index) {
                        ...
                        $.ajax({
                            type: "post",
                            url: '${path }/business/mjfdlvehicle/delete',
                            data: {"id": data.id},
                            dataType: 'json',
                            success: function (data) {
                                if (data.success) {
