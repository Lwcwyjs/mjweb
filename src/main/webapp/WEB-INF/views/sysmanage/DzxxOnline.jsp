            ...
            <div class="layui-form toolbar" id="vehicleForm">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <label class="layui-form-label">道闸状态</label>
                        <div class="layui-input-inline">
                            <select id="dzzt" name="dzzt" lay-filter="shztFilter">
...
<script>
    layui.config({
        ...
        var renderTable = function () {
            table.render({
                elem: '#dzxxTable'
                , url: '${path}/admin/dzxxOnline/DataGrid?nowTime=' + new Date().getTime()
                , method: 'GET'
                , request: {
                ...
                , cols: [[
                    ...
                    , {field: 'isonline', title: '道闸状态', sort: true, templet: function (d, row, index) {
        ...
        $('#exportExcel').click(function () {
            ...
            var organ = $('#organ').val();
            var dzzt = $('#dzzt').val();
            window.location.href = '${path}/admin/dzxxOnline/getExcel?dzbh=' + dzbh + '&qybh=' + organ + '&dzzt=' + dzzt;
        });
