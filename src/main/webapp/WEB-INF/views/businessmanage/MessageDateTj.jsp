            ...
            <div class="layui-form toolbar" id="dataBaseSearchForm">
                <div class="layui-form-item" lay-filter="searchForm">
                    ...
                    <div class="layui-input-inline" style="width: 70px">
                        <select id="tjfs" name="tjfs" lay-filter="shztFilter" style="width: 70px">
...
<script>
    layui.config({
        ...
        table.render({
            ...
            , cols: [[{field: 'tjsj', title: '统计时间', align: 'center', width: "25%", sort: true, totalRowText:"合计:"}
        ...
        $.ajax({
            type: "post",
            url: '${path}/messagedate/combox?oi_name=客服',
            dataType: 'json',
        ...
        $('#exportExcel').click(function () {
            ...
            var jssj = $('#jssj').val();
            var tjfs = $('#tjfs').val();
            window.location.href = '${path}/messagedate/exportMessageExcel?kfid=' + kfid + '&kssj=' + kssj + '&jssj=' + jssj+ '&tjfs=' + tjfs;
            // 模拟从后端接口读取需要导出的数据
        });
        // 清空按钮点击事件
