    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <form id="" class="layui-form" method="post">
                ...
                <div class="layui-form-item" lay-filter="searchForm">
                    <label class="layui-form-label">摆杆状态</label>
                    <div class="layui-input-inline">
                        <select id="bgzt" name="bgzt" lay-filter="shztFilter">
                            <option value="">请选择</option>
                            <option value="0">未摆杆</option>
                            <option value="1">人工抬杆</option>
                            <option value="2">自动摆杆</option>
                        </select>
                    </div>
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <script type="text/html" id="actionHandle">
                ...
                <shiro:hasPermission name="/business/txjl/yshw">
...
<script>
    layui.config({
        ...
        var renderTable = function () {
            table.render({
                elem: '#vehicleTable'
                , url: '${path}/business/txjl/DataGrid?nowTime=' + new Date().getTime()
                , method: 'GET'
                , request: {
        ...
        table.on('tool(view)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                parent.layer.open({
                    ...
                    area: ['98%', '98%'],
                    content: ['${path}/business/txjl/showPage?id=' + data.id + '&type=0']
                });
            }
            if (obj.event === 'edityshw') {
                ...
                parent.layer.open({
                    ...
                    area: ['500px', '320px'],
                    skin: 'my-skin',
                    content: ['${path}/business/txjl/editPage?id=' + data.id],
                    end: function () {
                        renderTable();
                    }
                });
        ...
        $('#exportExcel').click(function () {
            ...
            // 3. 发起导出请求（保持不变）
            var url = '${path}/business/txjl/startExport';
            var params = {
                cphm: cphm,
                cpys: cpys,
                organ: organ,
                ...
                success: function (data) {
                    if (data.code == 1) {
                        ...
                        var pollInterval = setInterval(function () {
                            $.ajax({
                                type: "post",
                                url: '${path}/business/txjl/exportProgress',
                                data: {taskId: taskId},
                                dataType: 'json',
                                success: function (progressRes) {
                                    ...
                                    if (progress === -1) {
                                        ...
                                        setTimeout(function () {
                                            window.location.href = '${path}/business/txjl/downloadExcel?taskId=' + taskId;
                                            resetUI(); // 下载后重置
                                        }, 500);
                                    } else {
                                        // 更新进度
