 ...
 */
@Controller
@RequestMapping("/admin/sysquery")
public class SysDataQueryController extends BaseController {
    ...
    public Object dataGrid(SysCode sysCode, Integer page, Integer rows, String sort, String order) {
        ...
        publicService.selectPageObjects(pageInfo, "ai_sys_code", "", "", strWhere, new SysCode());
        return pageInfo;
    }
