...
public class ClassLoaderUtil {
	 ...
	 * 
	 * @paramrelativePath必须传递资源的相对路径。是相对于classpath的路径。如果需要查找classpath外部的资源，需要使用.
	 * ./来查找
	 * @return 文件输入流
	 * @throwsIOException
	...
	/**
	 *
	 * @paramrelativePath 必须传递资源的相对路径。是相对于classpath的路径。如果需要查找classpath外部的资源，需要使用
	 *                    ../来查找
	 * @return资源的绝对URL
	 * @throwsMalformedURLException
	 */
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		ClassLoaderUtil.getExtendResource("../config/jdbc.properties");

		System.out.println(ClassLoaderUtil.getClassLoader().getResource("../config/jdbc.properties").toString());
