    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="layui-form toolbar" id="vehicleForm">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select id="jclx" name="jclx" lay-filter="crkbhFilter" lay-verify="required"
                                    lay-search>
            ...
            <div class="layui-row">
                ...
                <table class="layui-hide" id="spxxTable" lay-filter="vehicleFilter"></table>
            </div>


            <script type="text/html" id="actionHandle" lay-event="detail">
                <shiro:hasPermission name="/admin/spxx/edit">
                ...
                <shiro:hasPermission name="/admin/spxx/del">
					<span style="height: 24px; background-color: transparent; cursor: pointer;"
    ...
    layui.config({
        ...
        var renderTable = function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    {field: 'jclx', title: '进出类型', sort: true, templet: function (d, row, index) {
                            var value = d.jclx;
                            switch (value) {
                                case "1":
                                    return "进";
                    ...
                    , {field: 'sxtbh', title: '摄像头编号', sort: true}
                    , {
        ...
        $(document).on('click', '#addDetail', function () {
            ...
            parent.layer.open({
                ...
                skin: 'my-skin',
                area: ['800px', '600px'],
                content: ['${path}/admin/spxx/addPage'],
                end: function () {
                    renderTable();
                }
            });
        ...
        table.on('tool(vehicleFilter)', function (obj) {
            ...
            if (obj.event === 'editDetail') {
                ...
                parent.layer.open({
                    ...
                    area: ['800px', '600px'],
                    skin: 'my-skin',
                    content: ['${path}/admin/spxx/editPage?id=' + data.id],
                    end: function () {
                        renderTable();
                    }
                });
