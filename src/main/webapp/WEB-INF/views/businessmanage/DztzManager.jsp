    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <script type="text/html" id="actionHandle">
                ...
                <shiro:hasPermission name="/business/dztz/yshw">
...
<script>
    layui.config({
        ...
        var renderTable = function () {
            table.render({
                elem: '#vehicleTable'
                , url: '${path}/business/dztz/DataGrid?nowTime=' + new Date().getTime()
                , method: 'GET'
                , request: {
                ...
                , cols: [[
                    ...
                    {field: 'jcyshwmc', title: '进厂运输货物名称', align: 'center', sort: true},
                    {field: 'ccyshwmc', title: '出厂运输货物名称', align: 'center', sort: true},
                    {field: 'jcsj', title: '进厂时间', align: 'center', sort: true},
                    {field: 'ccsj', title: '出厂时间', align: 'center', sort: true},
        ...
        table.on('tool(view)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                parent.layer.open({
                    ...
                    area: ['98%', '98%'],
                    content: ['${path}/business/dztz/showPage?id=' + data.id + '&type=0']
                });
            }
            if (obj.event === 'edityshw') {
                ...
                parent.layer.open({
                    ...
                    area: ['500px', '450px'],
                    skin: 'my-skin',
                    content: ['${path}/business/dztz/editPage?id=' + data.id],
                    end: function () {
                        renderTable();
                    }
                });
        ...
        $('#exportExcel').click(function () {
            ...
            // 3. 发起导出请求（保持不变）
            var url = '${path}/business/dztz/startExport';
            var params = {
                cphm: $('#cphm').val(),
                cpys: $('#cpys').val(),
                organ: $('#organ').val(),
                ...
                success: function (data) {
                    if (data.code == 1) {
                        ...
                        var pollInterval = setInterval(function () {
                            $.ajax({
                                type: "post",
                                url: '${path}/business/dztz/exportProgress',
                                data: {taskId: taskId},
                                dataType: 'json',
