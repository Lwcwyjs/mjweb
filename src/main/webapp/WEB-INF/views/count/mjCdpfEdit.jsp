...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="layui-form toolbar" id="queryFormItem" lay-filter="mjcdpfForm">
                <input id="id" name="id"  value="${mjcdpf.id}" type="hidden">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input id="ysw" name="ysw" placeholder="" class="layui-input" lay-verify="required"
                                       value="${mjcdpf.ysw}"/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-inline">
                            <label class="layui-form-label">运输时间</label>
                            <div class="layui-input-inline">
                                <input type="text" name="yssj" id="yssj" lay-verify="yssj"
                                       placeholder=""
                                       autocomplete="off" class="layui-input" value="${yssj}">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    layui.config({
        ...
        $('#organ').val('${mjcdpf.organ}');
        form.render();
        form.on('submit(submitForm)', function (data) {
            // 关键修复：先判断表单数据是否存在，再处理 crkbh
            var formData = data.field;
            var params = {id: formData.id,ysw: formData.ysw,ysl: formData.ysl,
                organ:formData.organ,yssj:formData.yssj};
            console.log(params);
            //data.field 当前容器的全部表单字段，名值对形式：{name: value}
            $.ajax({
                type: "post",
                url: '${path}/count/cdpf/${oper}',
                data: params,
                dataType: 'json',
