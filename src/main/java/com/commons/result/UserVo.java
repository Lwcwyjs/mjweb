...
public class UserVo implements Serializable {
	...
	public String toString() {
		return "UserVo [id=" + id + ", loginname=" + loginname + ", name=" + name + ", password=" + password + ", sex="
				+ sex + ", age=" + age + ", usertype=" + usertype + ", status=" + status + ", organizationId="
				+ organizationId + ", organizationCode=" + organizationCode + ", createdate=" + createdate + ", phone="
				+ phone + ", rolesList=" + rolesList + ", organizationName=" + organizationName + ", roleIds=" + roleIds
