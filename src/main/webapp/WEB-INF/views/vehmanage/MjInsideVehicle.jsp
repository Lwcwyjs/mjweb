    ...
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <script type="text/html" id="actionHandle" lay-event="detail">
                <shiro:hasPermission name="/business/mjinsidevehicle/edit">
                ...
                <shiro:hasPermission name="/business/mjinsidevehicle/del">
					<span style="height: 24px; background-color: transparent; cursor: pointer;"
...
<script>
    layui.config({
        ...
        var renderTable = function () {
            ...
            table.render({
                elem: '#vehTable'
                , url: '${path}/business/mjinsidevehicle/dataGrid'
                , method: 'GET'
                , request: {
                ...
                , cols: [[
                    ...
                    {field: 'cjsj', title: '创建时间', align: 'center', sort: true},
                    {
        ...
        $(document).on('click', '#addDetail', function () {
            ...
            parent.layer.open({
                ...
                skin: 'my-skin',
                area: ['800px', '600px'],
                content: ['${path}/business/mjinsidevehicle/addPage'],
                end: function () {
                    renderTable();
                }
            });
        ...
        table.on('tool(vehicleFilter)', function (obj) {
            ...
            if (obj.event === 'editDetail') {
                ...
                parent.layer.open({
                    ...
                    area: ['800px', '600px'],
                    skin: 'my-skin',
                    content: ['${path}/business/mjinsidevehicle/editPage?id=' + data.id],
                    end: function () {
                        renderTable();
                    }
                });
                ...
                layer.confirm('确定要删除吗',
                    function (index) {
                        ...
                        $.ajax({
                            type: "post",
                            url: '${path }/business/mjinsidevehicle/delete',
                            data: {"id": data.id},
                            dataType: 'json',
