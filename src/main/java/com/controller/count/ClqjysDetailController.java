 ...
 */
@Controller
@RequestMapping("/count/clqjysDetail")
public class ClqjysDetailController extends BaseController {
    ...
    @RequestMapping("/main")
    public String main() {
        return "count/ClqjysDetailManager";
    }
    ...
    public Object cltxpfsjysw(@RequestParam Map<String, Object> params, HttpServletRequest request) {
        ...
        strWhere+=" and isnull(yshwmc,'')<>'' and yshwmc<>'未知'";
